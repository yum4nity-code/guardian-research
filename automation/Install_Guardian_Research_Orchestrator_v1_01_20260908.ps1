...
Write-Host "=== GUARDIAN AUTONOMOUS RESEARCH ORCHESTRATOR installer v1.01 ===" -ForegroundColor Cyan
...
# End-to-end dry run before installing persistence. It may legitimately report WAITING
# while Phase I-B is not PASS, but it must successfully clone/fetch main, parse the queue,
# enforce the 2026 gate and write health state.
