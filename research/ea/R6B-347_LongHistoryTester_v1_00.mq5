...
#property description "R6B-347 frozen long-history MT5 Strategy Tester harness. TESTER ONLY."

#include <Trade/Trade.mqh>

input double InpVolume = 1.00;

const string CANDIDATE_ID = "R6B-347";
const int LOOKBACK_BARS = 96;
const double BUFFER_ATR = 0.10;
const int HORIZON_BARS = 96;
const int SESSION_START = 0;
const int SESSION_END = 8;
const long MAGIC = 6347001;
