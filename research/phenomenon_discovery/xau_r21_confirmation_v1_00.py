...
def _validate_builder_receipt(receipt: dict, generated_csv: Path) -> None:
    expected = {
        ...
        "source_days": sealed_builder.EXPECTED_SOURCE_DAYS,
        "expected_source_days": sealed_builder.EXPECTED_SOURCE_DAYS,
        "first_opened_payload_date": CONFIRMATION_START.isoformat(),
        "last_opened_payload_date": CONFIRMATION_END.isoformat(),
