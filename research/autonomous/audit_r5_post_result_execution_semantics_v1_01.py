...
def raw_m1_reference_return(
    ...
    """Infrastructure-equivalent repair of v1_00 using explicit nanosecond timestamps.
...
# Patch only the infrastructure-defective timestamp conversion used by base.main().
base.raw_m1_reference_return = raw_m1_reference_return

# Re-export frozen constants/helpers for deterministic preflight assertions.
