...
$Out = Join-Path $Root "Research\ExecutionAudit\V111_AUDUSD_H21_240M_$Stamp"
$Zip = Join-Path ([Environment]::GetFolderPath("Desktop")) "GUARDIAN_V111_AUDUSD_H21_240M_OOS_FTMO_$Stamp.zip"
New-Item -ItemType Directory -Force -Path $Out | Out-Null
$Py = Join-Path $Root "guardian-research\tools\guardian_v111_audusd_h21_240m_oos_ftmo_v1_00.py"
Write-Host "=== V111 AUDUSD H21 SHORT 240m - ENDPOINT OOS + FTMO ===" -ForegroundColor Cyan
