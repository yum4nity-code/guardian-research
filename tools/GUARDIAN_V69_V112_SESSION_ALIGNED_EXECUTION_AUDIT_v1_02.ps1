...
$Py=Join-Path $PSScriptRoot "guardian_v69_v112_session_aligned_execution_audit_v1_02.py"
Write-Host "=== SESSION-ALIGNED EXECUTION AUDIT v1.02 ===" -ForegroundColor Cyan
