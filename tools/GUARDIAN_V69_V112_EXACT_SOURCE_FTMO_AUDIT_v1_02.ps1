...
$Py=Join-Path $PSScriptRoot "guardian_v69_v112_exact_source_ftmo_audit_v1_02.py"
New-Item -ItemType Directory -Force -Path $Out | Out-Null
Write-Host "=== EXACT ORIGINAL EVENTS -> FTMO EXECUTION AUDIT v1.02 ===" -ForegroundColor Cyan
Write-Host "2026: BLOCKED" -ForegroundColor Yellow
Write-Host "Exact source parity first; then FTMO history availability + pricing."
