...
$Out = Join-Path $Root "Research\ExecutionAudit\V111_EURUSD_H11_120M_$Stamp"
$Zip = Join-Path ([Environment]::GetFolderPath("Desktop")) "GUARDIAN_V111_EURUSD_H11_120M_OOS_FTMO_$Stamp.zip"
New-Item -ItemType Directory -Force -Path $Out | Out-Null
$Py = Join-Path $Root "guardian-research\tools\guardian_v111_eurusd_h11_120m_oos_ftmo_v1_00.py"

Write-Host "=== V111 EURUSD H11 SHORT 120m - OOS + FTMO PIPELINE ===" -ForegroundColor Cyan
