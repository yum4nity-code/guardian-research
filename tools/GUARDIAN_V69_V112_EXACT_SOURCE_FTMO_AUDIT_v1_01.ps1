...
$Py=Join-Path $PSScriptRoot "guardian_v69_v112_exact_source_ftmo_audit_v1_01.py"
New-Item -ItemType Directory -Force -Path $Out | Out-Null
Write-Host "=== EXACT ORIGINAL EVENTS -> FTMO EXECUTION AUDIT v1.01 ===" -ForegroundColor Cyan
