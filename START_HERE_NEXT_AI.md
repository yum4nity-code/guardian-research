...
Read `CURRENT_PROJECT_HANDOFF.md`, then `EDGE_FAMILY_MAP.md`, then the master mandate/protocol.

V32–V37 regime/shock is CLOSED. Do not rescue it. Its sole candidate passed V36 validation but failed V37 final pre-OOS tail robustness (best-2% trim negative). Locked OOS 2023–2025 and 2026 remain unopened.
